...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Causable', fields ['user']
        db.delete_unique('create_causable', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Causable', fields ['user']
        db.create_unique('create_causable', ['user_id'])
    ...
    models = {
        ...
        'create.causable': {
            ...
            'play': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['play.Playable']", 'unique': 'True'}),
