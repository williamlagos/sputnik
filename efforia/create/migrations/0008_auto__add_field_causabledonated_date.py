...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CausableDonated.date'
        db.add_column('create_causabledonated', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 8, 25), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CausableDonated.date'
        db.delete_column('create_causabledonated', 'date')
