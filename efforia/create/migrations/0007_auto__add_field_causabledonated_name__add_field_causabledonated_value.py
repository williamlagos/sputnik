...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CausableDonated.name'
        db.add_column('create_causabledonated', 'name', self.gf('django.db.models.fields.CharField')(default='$#', max_length=10), keep_default=False)

        # Adding field 'CausableDonated.value'
        db.add_column('create_causabledonated', 'value', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CausableDonated.name'
        db.delete_column('create_causabledonated', 'name')

        # Deleting field 'CausableDonated.value'
        db.delete_column('create_causabledonated', 'value')
    ...
    models = {
        ...
        'create.causable': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 8, 25)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'play': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['play.Playable']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 8, 25)'}),
        ...
        'play.playable': {
            ...
            'credit': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 8, 25)', 'auto_now_add': 'True', 'blank': 'True'}),
