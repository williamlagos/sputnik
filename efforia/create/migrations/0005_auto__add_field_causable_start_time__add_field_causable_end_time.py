...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Causable.start_time'
        db.add_column('create_causable', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 8, 0, 0)),
                      keep_default=False)

        # Adding field 'Causable.end_time'
        db.add_column('create_causable', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 8, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Causable.start_time'
        db.delete_column('create_causable', 'start_time')

        # Deleting field 'Causable.end_time'
        db.delete_column('create_causable', 'end_time')
    ...
    models = {
        ...
        'create.causable': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'play': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['play.Playable']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
        ...
        'play.playable': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
