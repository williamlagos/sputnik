...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CausableSpread.user'
        db.add_column('create_causablespread', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='+', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CausableSpread.user'
        db.delete_column('create_causablespread', 'user_id')
