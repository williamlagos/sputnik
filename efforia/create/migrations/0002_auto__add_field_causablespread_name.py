...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CausableSpread.name'
        db.add_column('create_causablespread', 'name', self.gf('django.db.models.fields.CharField')(default='#', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CausableSpread.name'
        db.delete_column('create_causablespread', 'name')
