...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Playable.name'
        db.alter_column('play_playable', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))


    def backwards(self, orm):
        
        # Changing field 'Playable.name'
        db.alter_column('play_playable', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
