...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('play_schedulefollow', (
            ...
            ('follow', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['play.Schedule'])),
    ...
    models = {
        ...
        'play.playable': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
