...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('play_playablepurchased', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner', to=orm['auth.User'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='video', to=orm['play.Playable'])),
        ))
        db.send_create_signal('play', ['PlayablePurchased'])


    def backwards(self, orm):
        # Deleting model 'PlayablePurchased'
        db.delete_table('play_playablepurchased')
