...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playable.credit'
        db.add_column('play_playable', 'credit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playable.credit'
        db.delete_column('play_playable', 'credit')
