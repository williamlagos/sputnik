...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_event', (
            ...
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 8))),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 8))),
        ...
        db.create_table('core_place', (
            ...
            ('latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ))
    ...
    models = {
        ...
        'core.event': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 8)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 8)'})
        },
        'core.place': {
        ...
        'core.userprofile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 8)'}),
