...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_profile', (
            ...
            ('visual', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('birthday', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 9))),
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_userprofile', (
            ...
            ('facebook_token', self.gf('django.db.models.fields.TextField')(default='', max_length=120)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('birthday', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 8))),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
