...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sellable.date'
        db.add_column(u'efforia_sellable', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 16, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sellable.date'
        db.delete_column(u'efforia_sellable', 'date')
    ...
    models = {
        ...
        u'efforia.profile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 16, 0, 0)'}),
