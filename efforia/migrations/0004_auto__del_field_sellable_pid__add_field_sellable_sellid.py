...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sellable.pid'
        db.delete_column(u'efforia_sellable', 'pid')

        # Adding field 'Sellable.sellid'
        db.add_column(u'efforia_sellable', 'sellid',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sellable.pid'
        db.add_column(u'efforia_sellable', 'pid',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Sellable.sellid'
        db.delete_column(u'efforia_sellable', 'sellid')
