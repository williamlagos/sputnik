...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('store_cart', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Changing field 'Cart.name'
        db.alter_column('store_cart', 'name', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Deleting field 'Cart.quantity'
        db.delete_column('store_cart', 'quantity')

        # Changing field 'Cart.name'
        db.alter_column('store_cart', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'store.product': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 6, 18)', 'auto_now_add': 'True', 'blank': 'True'}),
