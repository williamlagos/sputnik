...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deliverable.code'
        db.add_column('store_deliverable', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Deliverable.mail_code'
        db.add_column('store_deliverable', 'mail_code', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Deliverable.length'
        db.add_column('store_deliverable', 'length', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Deliverable.code'
        db.delete_column('store_deliverable', 'code')

        # Deleting field 'Deliverable.mail_code'
        db.delete_column('store_deliverable', 'mail_code')

        # Deleting field 'Deliverable.length'
        db.delete_column('store_deliverable', 'length')
