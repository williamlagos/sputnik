...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('create_keyword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(default='', max_length=25)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['create.Causable'])),
        ))
        db.send_create_signal('create', ['Keyword'])


    def backwards(self, orm):
        # Deleting model 'Keyword'
        db.delete_table('create_keyword')
