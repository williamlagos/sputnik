...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Causable.token'
        db.delete_column('create_causable', 'token')

        # Adding field 'Causable.ytoken'
        db.add_column('create_causable', 'ytoken',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)

        # Adding field 'Causable.visual'
        db.add_column('create_causable', 'visual',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Causable.token'
        db.add_column('create_causable', 'token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)

        # Deleting field 'Causable.ytoken'
        db.delete_column('create_causable', 'ytoken')
    ...
    models = {
        ...
        'create.causable': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)'}),
