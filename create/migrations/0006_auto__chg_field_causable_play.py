...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Causable.play'
        db.alter_column('create_causable', 'play_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spread.Playable']))

    def backwards(self, orm):

        # Changing field 'Causable.play'
        db.alter_column('create_causable', 'play_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['play.Playable']))
    ...
    models = {
        ...
        'create.causable': {
            ...
            'play': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['spread.Playable']"}),
        ...
        'spread.playable': {
            ...
            'credit': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
