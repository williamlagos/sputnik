...
from efforia.paypal.standard.conf import *
from efforia.paypal.standard.widgets import ValueHiddenInput, ReservedValueHiddenInput
from efforia.paypal.standard.conf import (POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT, 
    RECEIVER_EMAIL)
