...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PlayableFan'
        db.delete_table('spread_playablefan')
        ...
        # Renaming column for 'Spreaded.user' to match new field type.
        db.rename_column('spread_spreaded', 'user', 'user_id')
        # Changing field 'Spreaded.user'
        db.alter_column('spread_spreaded', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding index on 'Spreaded', fields ['user']
        db.create_index('spread_spreaded', ['user_id'])


    def backwards(self, orm):
        # Removing index on 'Spreaded', fields ['user']
        db.delete_index('spread_spreaded', ['user_id'])

        # Adding model 'PlayableFan'
        db.create_table('spread_playablefan', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('fan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['spread.Playable'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
        ))
        db.send_create_signal('spread', ['PlayableFan'])

        # Adding model 'EventSpread'
        db.create_table('spread_eventspread', (
            ('spreaded', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['spread.Event'])),
        ...
        # Renaming column for 'Spreaded.user' to match new field type.
        db.rename_column('spread_spreaded', 'user_id', 'user')
        # Changing field 'Spreaded.user'
        db.alter_column('spread_spreaded', 'user', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'spread.event': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
