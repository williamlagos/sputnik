...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.credit'
        db.alter_column(u'spread_product', 'credit', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Product.visual'
        db.alter_column(u'spread_product', 'visual', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Product.credit'
        db.alter_column(u'spread_product', 'credit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Product.visual'
        db.alter_column(u'spread_product', 'visual', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'spread.deliverable': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
