...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('spread_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 19))),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 19))),
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 19), auto_now_add=True, blank=True)),
        ))
