...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Playable.visual'
        db.alter_column('play_playable', 'visual', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'Playable.visual'
        db.alter_column('play_playable', 'visual', self.gf('django.db.models.fields.CharField')(max_length=35))
