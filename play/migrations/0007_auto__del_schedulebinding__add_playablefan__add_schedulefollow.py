...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('play_playablefan', (
        ...
        db.send_create_signal('play', ['PlayableFan'])

        # Adding model 'ScheduleFollow'
        db.create_table('play_schedulefollow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sched', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['play.Schedule'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 28), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('play', ['ScheduleFollow'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('play_schedulebinding', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 5, 17), auto_now_add=True, blank=True)),
            ('bind', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['play.Schedule'])),
            ('play', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['play.Schedule'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('play', ['ScheduleBinding'])

        # Deleting model 'PlayableFan'
        db.delete_table('play_playablefan')

        # Deleting model 'ScheduleFollow'
        db.delete_table('play_schedulefollow')
