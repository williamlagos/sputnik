...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playable.category'
        db.add_column('play_playable', 'category', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playable.category'
        db.delete_column('play_playable', 'category')
    ...
    models = {
        ...
        'play.playable': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 17)', 'auto_now_add': 'True', 'blank': 'True'}),
