...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playable.visual'
        db.add_column('play_playable', 'visual', self.gf('django.db.models.fields.CharField')(default='', max_length=35), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playable.visual'
        db.delete_column('play_playable', 'visual')
