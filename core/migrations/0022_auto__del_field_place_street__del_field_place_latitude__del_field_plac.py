...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_place', 'street')

        # Deleting field 'Place.latitude'
        db.delete_column('core_place', 'latitude')

        # Deleting field 'Place.longitude'
        db.delete_column('core_place', 'longitude')

        # Adding field 'Place.code'
        db.add_column('core_place', 'code',
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_place', 'street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Place.latitude'
        db.add_column('core_place', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Place.longitude'
        db.add_column('core_place', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Place.code'
        db.delete_column('core_place', 'code')
