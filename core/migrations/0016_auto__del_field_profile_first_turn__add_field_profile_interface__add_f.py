...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.first_turn'
        db.delete_column('core_profile', 'first_turn')
        ...
        db.add_column('core_profile', 'language',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.first_turn'
        db.add_column('core_profile', 'first_turn',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        db.delete_column('core_profile', 'language')
