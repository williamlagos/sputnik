...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_followed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fan', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('user', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('core', ['Followed'])


    def backwards(self, orm):
        # Deleting model 'Followed'
        db.delete_table('core_followed')
    ...
    models = {
        ...
        'core.followed': {
            ...
            'fan': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.IntegerField', [], {'default': '2'})
        },
        'core.place': {
        ...
        'core.profile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
