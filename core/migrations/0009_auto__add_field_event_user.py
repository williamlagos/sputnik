...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_event', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.user'
        db.delete_column('core_event', 'user_id')
    ...
    models = {
        ...
        'core.event': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 15)', 'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 15)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 15)'}),
        ...
        'core.profile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 15)'}),
