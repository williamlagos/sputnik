...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.career'
        db.add_column('core_profile', 'career',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Profile.bio'
        db.add_column('core_profile', 'bio',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.career'
        db.delete_column('core_profile', 'career')
