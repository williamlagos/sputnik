...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'promote_event', (
            ...
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 2, 0, 0))),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 2, 0, 0))),
    ...
    models = {
        ...
        u'promote.event': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 2, 0, 0)'}),
