...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.visual'
        db.add_column('promote_event', 'visual',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.visual'
        db.delete_column('promote_event', 'visual')
    ...
    models = {
        ...
        'promote.event': {
            'Meta': {'object_name': 'Event', '_ormbases': ['efforia.Sellable']},
            ...
            'sellable_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['efforia.Sellable']", 'unique': 'True', 'primary_key': 'True'}),
