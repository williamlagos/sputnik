...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Pledge.backer'
        db.delete_column(u'promote_pledge', 'backer_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Pledge.backer'
        db.add_column(u'promote_pledge', 'backer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='backer', to=orm['auth.User']),
                      keep_default=False)
