...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.event_id'
        db.add_column(u'promote_project', 'event_id',
                      self.gf('django.db.models.fields.CharField')(default='me', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.event_id'
        db.delete_column(u'promote_project', 'event_id')
