...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'spread_product', 'date')


        # Changing field 'Product.sellable_ptr'
        db.alter_column(u'spread_product', u'sellable_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['efforia.Sellable'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'Product.date'
        db.add_column(u'spread_product', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 16, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Product.sellable_ptr'
        db.alter_column(u'spread_product', 'sellable_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Sellable'], unique=True, primary_key=True))
