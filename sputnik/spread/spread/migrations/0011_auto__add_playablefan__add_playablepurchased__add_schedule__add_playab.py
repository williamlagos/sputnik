...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spread_playablepurchased', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('spread_schedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 7, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('spread', ['Schedule'])

        # Adding model 'Playable'
        db.create_table('spread_playable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('spread', ['Playable'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('spread_playablepurchased')

        # Deleting model 'Schedule'
        db.delete_table('spread_schedule')

        # Deleting model 'Playable'
        db.delete_table('spread_playable')
    ...
    models = {
        ...
        'spread.event': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)'}),
