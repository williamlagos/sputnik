...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sellable.visual'
        db.add_column(u'efforia_sellable', 'visual',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)


        # Changing field 'Sellable.name'
        db.alter_column(u'efforia_sellable', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Sellable.visual'
        db.delete_column(u'efforia_sellable', 'visual')


        # Changing field 'Sellable.name'
        db.alter_column(u'efforia_sellable', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        u'efforia.profile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
