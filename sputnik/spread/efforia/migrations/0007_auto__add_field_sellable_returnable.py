...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sellable.returnable'
        db.add_column(u'efforia_sellable', 'returnable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sellable.returnable'
        db.delete_column(u'efforia_sellable', 'returnable')
    ...
    models = {
        ...
        u'efforia.deliverable': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'efforia.profile': {
            ...
            'birthday': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 5, 0, 0)'}),
